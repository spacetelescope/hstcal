...
/* Image file name template descriptor.
   NOTE:  This version handles only one file name, no wildcards.
...
*/
        ...
        imt_descr->pattern = (char *)calloc (SZ_FNAME+1, sizeof(char));
...
/* Allocate and populate the list of file names.  xxx temporary xxx */
