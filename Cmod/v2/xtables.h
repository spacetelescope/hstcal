/* the first group of these should be set in c_iraf.h;
   IRAFPointer differs from its definition in the original c_iraf.h
*/
...
# define IRAF_COMPLEX     8
# define IRAF_USHORT     11
# define IRAF_UBYTE      12
...
/* the rest of these are used only by tables */
