/* ACS data structures.
 ...
 ----       ------      -----------
 1998-06-10 W.J. Hack   Initial ACS version.
 2001-10-29 W.J. Hack   Replaced 'ccdbias' with an array 'ccdbias[4]' to
                        be applied for each AMP. Added 'graph' and 'comp' to
                        replace 'phottab' and 'apertab' and removed 'filtcorr'.
                        Simplified PhotInfo to only contain a single set of
                        arrays for wave and thru.
 2001-12-04 W.J. Hack   Added expstart and expend.
 2016-01-15 P.L. Lim    Added darktime.
*/
