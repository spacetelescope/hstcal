...
/* This file contains a set of routines to get keyword values from
   ...
   In all cases the returned value is status.
    ...
    Howard Bushouse, 2003 Oct 27:
	Changed PutKeyBool function type from Bool to int.
*/
...
int PutKeyBool (Hdr *hd, char *keyword, Bool value, char *comment) {
